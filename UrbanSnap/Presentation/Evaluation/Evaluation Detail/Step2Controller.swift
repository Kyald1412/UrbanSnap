...
//        viewCanvas.translatesAutoresizingMaskIntoConstraints = false
        ...
        var layerMarkText = "Every photo has objects to be focused on. Now please mark your focus by using above pen tool and draw outlining the object focus.".withBoldText(text: "draw outlining the object focus.", font: UIFont.systemFont(ofSize: 14, weight: .regular))
