...
//        view.image = UIImage.assetSlider1
...
//
//
////            previewImage.topAnchor.constraint(equalTo: flashCameraButton.bottomAnchor, constant: 10),
////            previewImage.centerXAnchor.constraint(equalTo: view.safeAreaLayoutGuide.centerXAnchor),
////            previewImage.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: 30),
////            previewImage.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: -30),
//
